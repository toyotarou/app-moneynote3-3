...
class AppParamNotifier extends StateNotifier<AppParamsResponseState> {
  ...
  ///
  Future<void> setCalendarSelectedDate({required DateTime date}) async => state = state.copyWith(calendarSelectedDate: date);
  ...
  ///
  Future<void> setSameMonthIncomeDeleteFlag({required bool flag}) async => state = state.copyWith(sameMonthIncomeDeleteFlag: flag);
  ...
  ///
  Future<void> setSameDaySelectedDay({required int day}) async => state = state.copyWith(sameDaySelectedDay: day);
}
